...
SpiecEasiで要求されるpulsarパッケージがCRANレポジトリから削除されているので（2022年12月9日現在）、ソースからインストールしておく。
```{r}
install.packages("https://cran.r-project.org/src/contrib/Archive/pulsar/pulsar_0.3.8.tar.gz", repos=NULL)
```
