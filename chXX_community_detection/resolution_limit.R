...
modularity(g_6, mem)
set.seed(123)
plot(g_6, vertex.color=cols[mem], vertex.label=NA, main=paste("Q=",modularity(g_6, mem),sep=""))
...
modularity(g_9, mem)
set.seed(123)
plot(g_9, vertex.color=cols[mem], vertex.label=NA, main=paste("Q=",modularity(g_9, mem),sep=""))
